...
<div class="fixed top-0 left-0 z-20 flex w-full items-center justify-center bg-[#18181b] py-4">
	<div class="flex w-full items-center justify-start gap-2 px-4 pl-2 text-xl md:w-[80vw] md:gap-4">
		...
		<a
			href="/"
			class="ml-auto flex items-center justify-start gap-2 text-base transition hover:text-violet-400 md:ml-0"
		>
		...
		<a
			href="/"
			class="flex items-center justify-start gap-2 text-base transition hover:text-violet-400"
		>
